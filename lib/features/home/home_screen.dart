...
///
/// Hidden dev screen: tap the version/about row in Settings 7 times
/// within 3 seconds to access the ASR dev testing screen (Gate 1/2).
/// This is a dev-only feature and is not shown to end users.
/// (The trigger lives in settings_screen.dart, not here.)
library;
